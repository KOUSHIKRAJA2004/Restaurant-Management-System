...
<form method="POST" action="success_create.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="item_id" class="form-control <?php echo !$item_idErr ?:
                'is-invalid'; ?>" id="item_id" required item_id="item_id" placeholder="Enter Item ID" value="<?php echo $item_id; ?>"><br>
        ...
        <div class="form-group"> 
            ...
            <input type="text" name="item_name" id="item_name" placeholder="Enter Item Name" required class="form-control <?php echo (!empty($itemname_err)) ? 'is-invalid' : ''; ?>" ><br>
        ...
        <div class="form-group">
            ...
            <input min='0' type="number" name="item_price" id="item_price" placeholder="Enter Item Price" step="1" required class="form-control <?php echo (!empty($itemprice_err)) ? 'is-invalid' : ''; ?>" ><br>
            <span class="invalid-feedback"></span>
        </div>
        
        <div class="form-group">
            <label for="item_description">Item Description :</label>
            <textarea name="item_description" id="item_description" rows="4" placeholder="Description of the item" required class="form-control <?php echo (!empty($itemdescription_err)) ? 'is-invalid' : ''; ?>" ></textarea><br>
            <span class="invalid-feedback"></span>
        </div>

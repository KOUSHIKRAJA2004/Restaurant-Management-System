...
<body>
    ...
    <div class="login_wrapper">
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> KOUSHIK'S RESTAURANT</h1><span class="sr-only"></span></a>

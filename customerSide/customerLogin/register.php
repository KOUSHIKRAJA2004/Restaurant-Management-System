    ...
    <style>
        body {
            ...
            background-color:black;
             background-image: url('../image/black-plate.jpeg'); /* Set the background image path */
...
<body>
    ...
    <div class="register_wrapper"> <!-- Updated class name -->
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> KOUSHIK'S RESTAURANT</h1><span class="sr-only"></span></a><br>

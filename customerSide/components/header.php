            ...
            <div class="nav-bar">
                <div class="brand">
                    <a class="nav-link" href="../home/home.php#hero">
                        <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> KOUSHIK'S RESTAURANT</h1><span
                            class="sr-only"></span>
                    </a>
                </div>
                <div class="nav-list">
...
?>
                                <li><a href="<?= strpos($current_url, "http://localhost/RestaurantProject/customerSide/home/home.php#hero") !== false ? "#hero" : "http://localhost/RestaurantProject/customerSide/home/home.php#hero" ?>" data-after="Home">Home</a></li>
<?php

  ...
  <section id="footer">
    <div class="footer container">
        <div class="brand">
          <h1>KOUSHIK'S CAFE & RESTAURANT</h1>
      </div>
        <h2>Follow our Socials</h2>
      <div class="social-icon">
        <div class="social-item">
          <a href="https://www.facebook.com/share/1XDReFqr1C/"><img src="https://img.icons8.com/color/48/facebook.png" alt="facebook"/></a>
        </div>
        <div class="social-item">
          <a href="https://www.instagram.com/iam_koushikraja?igsh=MTYyMGo2emtxa3p0bw=="><img src="https://img.icons8.com/color/48/instagram-new.png" alt="instagram-new"/></a>
        </div>
          <!-- <div class="social-item">
          ...
          <div class="social-item">
          <a href="https://youtube.com/@koushipedia5925?si=fvocYEbmdrHoPTm9"><img src="https://img.icons8.com/color/48/youtube-play.png" alt="youtube-new"/></a>
        </div>
          
        
      </div>
      <p>© <?= date('Y') ?> KOUSHIK'S CAFE & RESTAURANT</p>
